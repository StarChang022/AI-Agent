...
BACKUP_PATH = "/Users/starchang/Documents/CloudFolder/GitHub/AI-Agent/PlayPlus_Cold_Mail/冷郵件對象/名單副本_backup_smb.csv"
JSON_PATH = "/Users/starchang/Documents/CloudFolder/GitHub/AI-Agent/PlayPlus_Cold_Mail/⌚️暫存/temporary_104.json"

# 定義特定作品集分類名單
FOOD_COMPANIES = {"全廣食品有限公司", "英辰食品有限公司", "茂生食品股份有限公司", "新蓬萊食品股份有限公司"}
MEDICAL_COMPANIES = {"鉅邦醫材股份有限公司"}
...
def generate_smb_emails(contact_name, company_name):
    ...
    if category == "tfif-app":
        ...
        day1_p2 = "我們是 PlayPlus，專注於協助企業打造「客製化內部系統」。我們不推銷繁雜昂貴的套裝系統，專注從你們最痛的流程開始，打造好紀錄、好追蹤、好交接的專屬系統。例如我們曾協助食品業者開發食安智幫手APP（https://playplus.com.tw/portfolio/tfif-app），協助現場同仁進行智慧化食安檢測與生產紀錄。"
        ...
        day1_p1 = f"我剛瀏覽了 {company_name} 的資料，注意到你們在醫療器材與呼吸設備領域已經有非常深厚的基礎。但在醫療與生醫產業成長的階段，許多團隊常會面臨臨床數據追蹤、檢驗報告紀錄與出貨品管等多個系統分散，導致人工彙整耗時且難以即時支援決策的問題。"
        day1_p2 = "我們是 PlayPlus，專注於協助企業打造「客製化內部系統」。我們不推銷繁雜的昂貴系統，專注從研發或管理同仁最痛的一條流程開始，打造好紀錄、好追蹤、好交接的專屬系統。例如我們曾協助腎臟醫學會開發 TSN 病理系統（https://playplus.com.tw/portfolio/tsn），整合病理數據與醫療流程，提升臨床管理的精準度。"
        day1_p3 = "是否方便寄一份我們過去在醫療相關產業的流程數位化案例給您參考？您可以從這邊參考我們的服務及作品集：https://playplus.com.tw/"
    else:
        # mitac
        day1_title = f"針對 {company_name} 的營運流程與系統優化：分享神達電腦案例"
        day1_p1 = f"我剛瀏覽了 {company_name} 的資料，注意到你們在製造與工業設備領域已經有非常深厚的基礎。但在企業成長的階段，許多團隊常會遇到內部管理與協作流程跟不上的問題，例如新人交接困難、流程只在資深同仁腦中，或是表單分散在 Excel 難以追蹤。"
        day1_p2 = "我們是 PlayPlus，專注於協助企業打造「客製化企業內部系統」。我們不推銷複雜昂貴的套裝系統，專注從你們最痛的一條流程開始，打造好紀錄、好追蹤、好交接的專屬系統。例如我們曾協助神達電腦開發會議室預約系統（https://playplus.com.tw/portfolio/mitac-meeting-room-booking-system），解決跨部門資源預約與協作的混亂問題。"
    ...
    if category == "tfif-app":
        day14_p1 = "在與許多食品業客戶的合作中，我們發現流程卡關並非技術問題，關鍵在於缺乏現場操作的流程梳理。在實際動手開發前，我們會深度盤點貴司從原料品管到出貨的商業邏輯，將紙本紀錄轉化為最適合現場操作的數位介面。"
        ...
        day14_p1 = "在與許多醫療與器材領域客戶的合作中，我們發現流程卡關並非技術問題，關鍵在於缺乏專業領域的流程梳理。在實際動手開發前，我們會深度盤點貴司研發或品管的商業邏輯，將分散的數據整合為單一且直觀的管理後台。"
        ...
        # mitac
        day14_p1 = "在與許多成長中企業的合作中，我們發現流程卡關並非技術問題，關鍵在於缺乏早期的「前半段」流程梳理。在實際動手開發前，我們會深度盤點貴司的商業邏輯，將隱形的流程轉化為標準化、數位化的動線。"
    ...
    day30_content = (
        ...
        f"<br>\n"
        f"我們 PlayPlus 理解這些顧慮，我們採取分階段付費與模組化開發，讓您先從一條最痛的流程（如報表彙整或交接紀錄）開始優化，看到成效後再逐步擴展。此外，我們的專業專案管理機制，每週只需佔用主管 15 分鐘確認進度，絕不增加團隊額外的溝通負擔。<br>\n"
        f"<br>\n"
