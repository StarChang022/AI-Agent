...
# -*- coding: utf-8 -*-
"""
為 Scenarios 為「大企業_企業內部系統」的潛在客戶生成 Day 1, Day 7, Day 30 冷郵件，
...
def generate_emails(contact_name, company_name):
    ...
    category = get_company_category(company_name)
    ...
    if category == "retail":
        ...
        day7_p2_detail = "特別是針對零售與食品通路常見的「跨國據點協作／跨部門單據審核」，"
        ...
        p3 = "作為神達集團長期合作的數位轉型與陪跑顧問，我們協助重新整合集團的供應商管理、跨部門人力調度等核心營運系統，專注於流程梳理與動線重構，將繁瑣的流程大幅降低人工比例，實質為他們提升集團綜效。"
        day7_p2_detail = "特別是針對製造業常見的「複雜的供應商對帳／跨部門單據審核」，"
