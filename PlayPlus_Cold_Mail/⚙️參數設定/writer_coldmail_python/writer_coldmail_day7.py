...
TITLE_COL = "day7_title"
CONTENT_COL = "day7_content"
STRATEGY = "快速溫和提醒 (The Gentle Nudge)"

def build_prompt(row: dict) -> str:
    company = row.get("公司品牌簡稱", "").strip()
    contact = row.get("聯絡人名稱", "官方").strip()
    day1_title = row.get("day1_title", "").strip()
    
    return f"{COMMON_RULES}\n【策略：{STRATEGY}】\n\n對象：{company}\n聯絡人：{contact}\n原標題：{day1_title}\n\n請撰寫 Day 7 短信（3句內，標題用 Re:）。"
