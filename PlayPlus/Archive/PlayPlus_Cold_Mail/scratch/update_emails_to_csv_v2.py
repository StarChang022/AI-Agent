...
for index, row in df.iterrows():
    ...
    industry = industry_mapping.get(co_name, "製造與實業")

    # Day 1 - More human, no "advice"
    d1_title = f"交流：關於 {co_name} 在內部流程上的一些觀察"
    d1_content = f"{greeting}<br><br>我最近接觸了幾家{industry}領域的企業，無意間也瀏覽到了貴公司的網站，對你們目前的成長與規模滿印象深刻的。<br><br>在與業界朋友交流的過程中，我發現大家在業務穩定擴張時，常常會遇到類似的煩惱：例如很多重要的作業流程只存在資深員工腦中，新人很難交接；或是到現在還依賴紙本或 Excel 填表單，每個月月底光是人工彙整報表就超級耗時。<br><br>這讓我滿好奇貴公司目前是不是也剛好在經歷這個陣痛期？我和我的團隊（PlayPlus）這陣子主要都在協助企業解決這類問題，幫大家量身打造好紀錄、好交接的輕量級內部系統。<br><br>如果這剛好也是您最近在苦惱的事，不知道方不方便讓我和您分享幾個我們幫別人處理過的真實案例？當作交個朋友、交流一下心得也可以。<br><br>這是我們團隊的網站，有空可以看看：https://playplus.com.tw/<br><br>感謝您"
    
    # Day 7 - Humanized nudge
    d7_title = f"快速問候一下（關於上週的流程優化交流）"
    d7_content = f"{greeting}<br><br>想說快速跟進一下我上週寄給您的信件。<br><br>我知道您平日業務肯定非常繁忙，可能信件被淹沒了。如果您對我們如何幫企業打造專屬內部系統、解決人工報表混亂有任何好奇，或是單純想交流一下，都歡迎隨時讓我知道喔！<br><br>感謝您"
    
    # Day 14 - Social proof but conversational
    ...
    # Day 30 - Addressing objections naturally
    ...
    # Day 60 - Break-up email, friendly and warm
...
print("Successfully regenerated more human-like emails and saved back to CSV!")
