| Item | Input |
| --- | --- |
| Title | Is a high 'Debt Ratio' always dangerous? You also have to look at their ability to pay it back. | ValueCafe |
| Description | Does a high debt ratio automatically mean a company is a risky bet? Not necessarily. To get the full picture, you’ve got to look at the interest coverage ratio and free cash flow. By digging into a company’s actual ability to pay its bills, you can make a much more accurate call on how much risk is really on the table. |
| Keywords | Debt ratio, debt-to-asset ratio, solvency, calculating debt ratio, what is a reasonable debt ratio, high debt ratio pros and cons, interest coverage ratio, free cash flow, debt-to-equity ratio, financial leverage, financial risk. |
