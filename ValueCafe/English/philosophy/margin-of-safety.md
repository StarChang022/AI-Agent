...
# Margin of Safety : protecting your portfolio and lowering the risk of making a mistake.

If you want to make sure you aren’t late for a 20-minute drive, you’d better head out 40 minutes early. You never know what the traffic is going to be like. Stop trying to time everything down to the second. You’re bound to miscalculate or run into something unexpected sooner or later. Do yourself a favor and build in a margin of error so you actually have some breathing room.
...
1. **Step 1** - Estimate the intrinsic value: Use the methods we covered earlier to figure out what the company is actually worth.
2. **Step 2** - Set your discount: A good rule of thumb is usually 20% to 30%. For example, if you think the value is $100, wait until it hits $80 before you buy.
3. **Step 3** - Adjust as you go: If a company's future is full of uncertainty, you should ask for a bigger discount. If it’s a high-quality company that’s very predictable, you can settle for a smaller one.
