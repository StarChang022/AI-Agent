...
**id**: income-statement
**title**: The income statement as a company’s report card for making money | Income Statement | ValueCafe
**description**: Think of the income statement as a company’s report card for making money. It’s the main place you go to see how much revenue a business is actually pulling in. In this article, we’ll dive into revenue, costs, and profit margins, and show you how to analyze key metrics like gross and operating margins. Using a simple example from Alphabet’s financial reports, you'll learn how to judge a company's profitability and the quality of its earnings.
**keywords**: Income statement, how to read an income statement, value investing, financial statement guide, beginner's guide to finance, revenue, costs, profit, profit margins, gross margin, operating margin, net income, cost structure, non-operating income
**list-summary**: A Must-Read for Value Investors and the Report Card on Profits and Costs
...
A Must-Read for Value Investors and the Report Card on Profits and Costs
...
![Income Statement](../images/statements/income-statement/income-statement.webp)

### The Details of Income Statement

1. Costs and expenses includes the following items, which are all added up to get the "Total costs and expenses" number:
   - Cost of revenues
   - Research and development
   - Sales and marketing
   - General and administrative
2. Income from operations is Revenues minus Total costs and expenses.
3. Income before income taxes is Income from operations plus Other income (expense), net.
4. Net income is Income before income taxes minus Provision for income taxes.

![Income Statement](../images/statements/income-statement/income-statement1.webp)
...
1. If your **cost** keeps creeping up as a percentage, it might mean they can't pass on rising material costs to customers, or their production is getting less efficient.
2. If **operating expenses** (as a percentage of revenue) keep rising, it could mean their spending on management, sales, or R&D isn't paying off. Or, they could just be wasting money on stuff that doesn't matter.
