...
def run_data_daily():
    """
    第一階段：下載每日交易資料（data_daily.py 邏輯）
    """
    start_all = time.time()
    ...
    try:
        ...
        wl_doc_id, wl_gid = parse_gsheet_url(WATCHLIST_URL)
...
def run_export_csv():
    """
    第二階段：匯出 CSV 檔案（export_csv.py 邏輯）
    """
    print("正在清空並重建輸出資料夾...")
...
def main():
    ...
    # ── 第二階段：匯出 CSV ───────────────────────────────────────────────
    print("【第二階段】匯出 CSV 檔案")
    print("─" * 50)
    run_export_csv()

    total_elapsed = time.time() - total_start
    print("\n★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★")
    print(f"  全部完成！總耗時：{total_elapsed:.2f} 秒")
    print("★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★")
