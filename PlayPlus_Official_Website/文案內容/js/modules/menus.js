CNVS.Menus = function() {
	...
	var _hover = function() {
		...
		var menuHoverDelay = getComputedStyle(__core.getVars.elHeader).getPropertyValue('--cnvs-primary-menu-submenu-display-speed') || '666ms';

		if( typeof menuHoverDelay === 'string' && menuHoverDelay.includes('ms') && !isNaN(menuHoverDelay.split('ms')[0]) ) {
			menuHoverDelay = menuHoverDelay.split('ms')[0];
		} else if( typeof menuHoverDelay === 'string' && menuHoverDelay.includes('s') && !isNaN(menuHoverDelay.split('s')[0]) ) {
			menuHoverDelay = menuHoverDelay.split('s')[0] * 1000;
		} else if( typeof menuHoverDelay === 'number' ) {
